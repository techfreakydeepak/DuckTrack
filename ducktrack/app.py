...
from PyQt6.QtWidgets import (
    QApplication, QCheckBox, QDialog, QFileDialog, QFormLayout, QLabel,
    QLineEdit, QMenu, QMessageBox, QPushButton, QSystemTrayIcon, QTextEdit,
    QVBoxLayout, QWidget
)
...
class MainInterface(QWidget):
    ...
    def init_tray(self):
        ...
        self.natural_scrolling_option = QAction("Natural Scrolling", checkable=True)
    ...
    def toggle_record(self):
        if not hasattr(self, "recorder_thread"):
            # Password handling, update here as needed
            password = "JQd0VScSsBXpzd3T"  # Use your actual password here

            # Pass the password to the Recorder class
            ...
            # Open the dialog to input title and description
    ...
    def play_latest_recording(self):
        ...
        if recording_path:
            ...
            self.display_error_message("No recordings found!")
    ...
    def update_pause_ui(self, is_paused):
        self.toggle_pause_button.setText("Resume Recording" if is_paused else "Pause Recording")
        self.toggle_pause_action.setText("Resume Recording" if is_paused else "Pause Recording")
